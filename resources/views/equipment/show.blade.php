                    ...
                    <div class="border-t border-green-200 pt-3 sm:pt-4 mt-3 sm:mt-4">
                        @if(isset($isOwner) && $isOwner)
                            ...
                            <button type="button" id="deleteEquipmentBtn" 
                                ...
                                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-2-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                        ...
                        @else
                            ...
                            <div class="flex gap-2">
                                ...
                                <button onclick="openReportModal()" 
                                    ...
                                    <svg class="w-3 h-3 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-1.333-1.964-1.333-2.732 0L4 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9 8s9 3.582 9 8z"></path>
                                    </svg>
                                    <span>Signaler</span>
                                </button>
                            </div>
                    ...
                    @foreach($similarEquipment as $item)
                        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                            <a href="{{ route('equipment.show', $item) }}">
                                <img src="{{ $item->main_photo ? Storage::url($item->main_photo) : (isset($item->photos[0]) ? Storage::url($item->photos[0]) : 'https://via.placeholder.com/300x150?text=No+Image') }}" alt="{{ $item->name }}" class="h-32 w-full object-cover">
                            </a>
                            <div class="p-2">
