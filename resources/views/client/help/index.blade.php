...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Centre d'aide</h1>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 bg-linear-to-r from-yellow-50 to-orange-50 border-b border-gray-200">
            <div class="flex items-center">
    ...
    <!-- Contact support -->
    <div class="mt-12 bg-linear-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg overflow-hidden">
