            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                <div class="lg:col-span-3">
                    <div class="profile-card bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
                        @if ($errors->any())
                            <div
                                class="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded relative fade-in-up">
                        ...
                        @if (session('success'))
                            <div class="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded relative fade-in-up"
                                id="success-message">
                                {{ session('success') }}
                            </div>
                        @endif
                        ...
                        <div class="profile-card bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6 mb-6">
                            <div class="section-header">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700">Ces informations seront visibles par les prestataires.
                                    </p>
                                </div>
                            </div>
                            <form action="{{ route('client.profile.update.personal') }}" method="POST"
                                ...
                                <div class="mt-5 md:mt-0">
                                    <div class="grid grid-cols-1 sm:grid-cols-6 gap-4 sm:gap-6 form-grid">
                                            ...
                                            <div
                                                ...
                                                @if(auth()->user()->client && auth()->user()->client->photo)
                                                    <img class="h-20 w-20 rounded-full object-cover shadow-lg"
                                                        src="{{ asset('storage/' . auth()->user()->client->photo) }}"
                                                        alt="Photo actuelle">
                                                @else
                                                    <div
                                        ...
                                        <div class="col-span-1 sm:col-span-3 form-col-span">
                                            <label for="address"
                                                class="block text-sm font-semibold text-gray-700 mb-2 mobile-mb-2">Localisation</label>
                                        ...
                                        <div class="col-span-1 sm:col-span-6 form-col-span">
                                            <label for="bio"
                                                class="block text-sm font-semibold text-gray-700 mb-2 mobile-mb-2">Présentation</label>
                                            <textarea name="bio" id="bio" rows="4"
                                                class="mt-1 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-lg px-4 py-3 transition duration-200 mobile-p-3 mobile-text-sm"
                                                placeholder="Présentez-vous en quelques mots...">{{ old('bio', auth()->user()->client->bio ?? '') }}</textarea>
                                            <p class="mt-2 text-sm text-gray-600 mobile-text-sm mobile-mt-4">Décrivez vos
                                                besoins habituels, vos préférences ou votre secteur d'activité.</p>
                                        </div>
                                    </div>
                                </div>
