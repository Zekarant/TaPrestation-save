            ...
            <div class="profile-card bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    <div class="flex items-center">
                        ...
                        @else
                            <div class="h-20 w-20 rounded-full bg-linear-to-br from-gray-100 to-gray-200 flex items-center justify-center shadow-lg">
                                        ...
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1">
                                                ...
                                                <div class="flex items-center mt-2 space-x-4">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-linear-to-r from-gray-100 to-gray-200 text-gray-800 shadow-sm">
                                                        <!-- Budget supprimé pour des raisons de confidentialité -->
                                                    </span>
                                                    @if($request->category)
                                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-linear-to-r from-blue-100 to-blue-200 text-blue-800 shadow-sm">
                                ...
                                @foreach($reviews as $review)
                                    <div class="review-card border border-gray-200 rounded-lg p-4">
                                        <div class="flex items-start">
                                            ...
                                            @else
                                                <div class="h-12 w-12 rounded-full bg-linear-to-br from-gray-100 to-gray-200 flex items-center justify-center shadow-md">
                    ...
                    <div class="profile-card bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
                        ...
                        <dl class="space-y-4">
                            <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                <div class="p-2 rounded-full bg-linear-to-br from-gray-100 to-gray-200 text-gray-600 shadow-md">
                            ...
                            <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                <div class="p-2 rounded-full bg-linear-to-br from-yellow-100 to-yellow-200 text-yellow-600 shadow-md">
