                            ...
                            <div class="flex items-center mb-4">
                                <div class="relative">
                                    @if($prestataire->photo)
                                        <x-media-image :path="$prestataire->photo" :alt="$prestataire->user ? $prestataire->user->name : 'Prestataire'" class="w-16 h-16 rounded-full object-cover border-2 border-gray-200" />
                                    @else
                                        <div class="w-16 h-16 rounded-full bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-xl border-2 border-gray-200">
        ...
        @else
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
                <div class="max-w-md mx-auto">
                    <div class="w-24 h-24 mx-auto mb-6 bg-linear-to-br from-yellow-100 to-yellow-200 rounded-full flex items-center justify-center">
