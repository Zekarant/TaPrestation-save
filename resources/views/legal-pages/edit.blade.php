...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 flex items-center">
                        ...
                        @endphp
                        <span class="w-12 h-12 bg-gradient-to-r {{ $colors[$page->slug] ?? 'from-gray-600 to-gray-700' }} rounded-xl flex items-center justify-center mr-4">
                            <i class="fas {{ $icons[$page->slug] ?? 'fa-file' }} text-white text-xl"></i>
                        </span>
                        Modifier : {{ $page->title }}
                    </h1>
        ...
        {{-- Formulaire --}}
        <form action="{{ route('admin.legal-pages.update', $page) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="p-6">
                    <div class="mb-4">
                        ...
                        <textarea name="content" 
                                  ...
                                  placeholder="Entrez le contenu de la page ici...">{{ old('content', $page->content) }}</textarea>
                    </div>
                        ...
                        <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <a href="{{ Storage::url($page->file_path) }}" target="_blank" class="text-sm text-blue-600 hover:underline">
