                ...
                <div class="bg-blue-50 border-l-4 rounded-xl p-6 @if($review->rating >= 4) border-green-500 @elseif($review->rating >= 3) border-yellow-500 @else border-red-500 @endif">
                    <div class="flex flex-col lg:flex-row justify-between items-start gap-4 mb-4">
                        <div class="flex items-start gap-4 flex-1">
                            ...
                            <div class="w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-semibold text-lg">
                    ...
                    @if($review->service)
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div class="w-10 h-10 rounded-lg bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-semibold">
