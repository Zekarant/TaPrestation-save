                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4 flex-1">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <div class="w-16 h-16 rounded-lg bg-linear-to-br from-green-400 to-green-600 flex items-center justify-center text-white font-bold text-xl">
...
function deleteEquipment(id) {
    ...
    if (!reason || reason.trim() === '') {
        alert('Vous devez fournir une raison pour supprimer cet équipement.');
        return;
    }
    if (confirm('Êtes-vous sûr de vouloir supprimer définitivement cet équipement ?')) {
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '{{ url("administrateur/equipment") }}/' + id;
        form.innerHTML = `
