            ...
            <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-4 sm:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-blue-900">{{ $activeClients ?? 0 }}</div>
                    </div>
                            ...
                            <div class="flex items-center space-x-4 flex-1">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="w-16 h-16 rounded-full overflow-hidden bg-blue-100 flex items-center justify-center border border-blue-200">
                                        @if($client->user && $client->user->profile_photo_url)
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-start justify-between mb-2">
                                        <div class="flex-1">
                                            <h3 class="text-lg font-bold text-blue-900 truncate">{{ $client->user->name ?? 'Compte introuvable' }}</h3>
                                            <div class="text-sm text-blue-600 mb-2">{{ $client->user->email ?? 'Email indisponible' }}</div>
                                            <div class="flex items-center gap-2 mt-1">
                                                @if($client->user && $client->user->is_blocked)
                                    ...
                                    <div class="flex items-center gap-4 text-xs text-gray-500">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span>{{ $client->client_requests_count ?? 0 }} demandes</span>
                                        </div>
                                        <div class="flex items-center gap-1">
                                            <i class="fas fa-star text-blue-500"></i>
                                            <span>{{ $client->reviews_count ?? 0 }} avis</span>
                                        </div>
                                        <div class="flex items-center gap-1">
