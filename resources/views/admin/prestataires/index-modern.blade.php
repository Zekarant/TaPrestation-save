...
<!-- Filters Panel -->
<div id="filtersPanel" style="display: none;" class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
                    ...
                    <div class="flex-shrink-0">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-10" style="display: none;" id="dropdown-{{ $prestataire->id }}">
                                    <div class="py-1">
...
<!-- Bulk Actions -->
<div id="bulkActions" style="display: none;" class="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-white px-8 py-4 rounded-xl shadow-lg border border-gray-200 z-50 max-w-[90vw]">
