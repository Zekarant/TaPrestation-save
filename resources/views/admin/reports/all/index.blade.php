                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            @if($report->report_type === 'urgent_sale')
                                                <a href="{{ route('administrateur.reports.urgent-sales.show', $report->id) }}" 
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <form action="{{ route('administrateur.reports.urgent-sales.update-status', $report->id) }}" method="POST" class="px-3 py-2">
                                                                @csrf
                                                                <select name="status" class="form-select form-select-sm" onchange="this.form.submit()">
                                                                    <option value="">-- Statut --</option>
                                                                    <option value="pending" {{ $report->status === 'pending' ? 'selected' : '' }}>En attente</option>
                                                                    <option value="reviewed" {{ $report->status === 'reviewed' ? 'selected' : '' }}>En cours</option>
                                                        ...
                                                        <li>
                                                            <form action="{{ route('administrateur.reports.urgent-sales.destroy', $report->id) }}" method="POST" onsubmit="return confirm('Supprimer ce signalement ?');">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            @else
                                                <a href="{{ route('administrateur.reports.equipments.show', $report->id) }}" 
                                                   class="btn btn-sm btn-primary" title="Voir les détails">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><h6 class="dropdown-header">Changer le statut</h6></li>
                                                        <li>
                                                            <form action="{{ route('administrateur.reports.equipments.update-status', $report->id) }}" method="POST" class="px-3 py-2">
                                                                @csrf
                                                                <select name="status" class="form-select form-select-sm" onchange="this.form.submit()">
                                                                    <option value="">-- Statut --</option>
                                                                    <option value="pending" {{ $report->status === 'pending' ? 'selected' : '' }}>En attente</option>
                                                        ...
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <form action="{{ route('administrateur.reports.equipments.destroy', $report->id) }}" method="POST" onsubmit="return confirm('Supprimer ce signalement ?');">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="dropdown-item text-danger">
                                                                    <i class="fas fa-trash me-2"></i>Supprimer
