        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden mb-6">
                    <div class="bg-linear-to-r from-blue-50 to-blue-100 px-4 sm:px-6 py-4 border-b border-blue-200">
                    ...
                    <div class="p-4 sm:p-6">
                        ...
                        <div class="flex items-center space-x-4 mb-6">
                            <div class="w-16 h-16 rounded-full flex items-center justify-center text-white font-bold text-xl
                                @if($user->role === 'administrateur') bg-linear-to-br from-blue-500 to-blue-700
                                @elseif($user->role === 'prestataire') bg-linear-to-br from-green-500 to-green-700
                                @else bg-linear-to-br from-cyan-500 to-cyan-700 @endif" title="{{ $user->name }}">
