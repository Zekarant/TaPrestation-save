                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4 flex-1">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <div class="w-16 h-16 rounded-lg bg-linear-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold text-xl">
...
function approveService(serviceId) {
    if (confirm('Êtes-vous sûr de vouloir approuver ce service ?')) {
        fetch(`/administrateur/services/${serviceId}/approve`, {
            method: 'POST',
            headers: {
        ...
        .catch(error => {
            ...
            showNotification('Erreur lors de l\'approbation du service.', 'error');
        });
    }
}
...
function activateService(serviceId) {
    if (confirm('Êtes-vous sûr de vouloir activer ce service ?')) {
        fetch(`/administrateur/services/${serviceId}/toggle-visibility`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
        ...
        .catch(error => {
            console.error('Erreur:', error);
            showNotification('Erreur lors de l\'activation du service.', 'error');
        });
    }
}
    }
...
function deactivateService(serviceId) {
    if (confirm('Êtes-vous sûr de vouloir désactiver ce service ?')) {
        fetch(`/administrateur/services/${serviceId}/deactivate`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
        ...
        .catch(error => {
            console.error('Erreur:', error);
            showNotification('Erreur lors de la désactivation du service.', 'error');
        });
    }
}
...
function deleteService(serviceId) {
    if (confirm('Êtes-vous sûr de vouloir supprimer ce service ? Cette action est irréversible.')) {
        fetch(`/administrateur/services/${serviceId}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
...
function bulkApprove() {
    ...
    if (confirm(`Êtes-vous sûr de vouloir approuver ${selectedIds.length} service(s) ?`)) {
        fetch('/administrateur/services/bulk-approve', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
        ...
        .catch(error => {
            console.error('Erreur:', error);
            showNotification('Erreur lors de l\'approbation en lot.', 'error');
        });
    }
}
...
function bulkDeactivate() {
    ...
    if (confirm(`Êtes-vous sûr de vouloir désactiver ${selectedIds.length} service(s) ?`)) {
        fetch('/administrateur/services/bulk-deactivate', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
        ...
        .catch(error => {
            console.error('Erreur:', error);
            showNotification('Erreur lors de la désactivation en lot.', 'error');
        });
    }
}
...
function bulkDelete() {
    ...
    if (confirm(`Êtes-vous sûr de vouloir supprimer ${selectedIds.length} service(s) ? Cette action est irréversible.`)) {
        fetch('/administrateur/services/bulk-delete', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
        ...
        .catch(error => {
            console.error('Erreur:', error);
            showNotification('Erreur lors de la suppression en lot.', 'error');
        });
    }
}
