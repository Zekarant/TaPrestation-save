...
<head>
    ...
    <!-- Tailwind CSS via Vite (production) -->
...
<body>
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('administrateur.prestataires.*') || request()->routeIs('admin.verifications.*') ? 'active' : '' }}" href="{{ route('administrateur.prestataires.index') }}">
                            <i class="fas fa-user-tie"></i>
                            <span>Prestataires</span>
                            @php $pendingCount = \App\Models\Prestataire::where('is_approved', false)->count(); @endphp
                            @if($pendingCount > 0)<span class="badge-notification">{{ $pendingCount }}</span>@endif
                        </a>
                    </div>
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.bookings.*') ? 'active' : '' }}" href="{{ route('admin.bookings.index') }}">
                            ...
                            @if($pendingBookings > 0)<span class="badge-notification">{{ $pendingBookings }}</span>@endif
                        </a>
                    </div>
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.finance.*') ? 'active' : '' }}" href="{{ route('admin.finance.dashboard') }}">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('administrateur.reports.*') ? 'active' : '' }}" href="{{ route('administrateur.reports.all.index') }}">
                            <i class="fas fa-flag"></i>
                            <span>Signalements</span>
                            @php
                                $totalReports = \App\Models\UrgentSaleReport::where('status', 'pending')->count() 
                                    + \App\Models\EquipmentReport::where('status', 'pending')->count() 
                                    + \App\Models\ServiceReport::where('status', 'pending')->count();
                            @endphp
                            @if($totalReports > 0)<span class="badge-notification">{{ $totalReports }}</span>@endif
                        </a>
                    </div>
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.messages.*') ? 'active' : '' }}" href="{{ route('admin.messages.index') }}">
                            ...
                            @php $reportedMsgs = \App\Models\Message::where('is_reported', true)->where('status', '!=', 'hidden')->count(); @endphp
                            @if($reportedMsgs > 0)<span class="badge-notification">{{ $reportedMsgs }}</span>@endif
                        </a>
                    </div>
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.notifications.*') ? 'active' : '' }}" href="{{ route('admin.notifications.index') }}">
                            ...
                            @php $unreadNotifs = \App\Models\Notification::where('read_at', null)->count(); @endphp
                            @if($unreadNotifs > 0)<span class="badge-notification">{{ $unreadNotifs }}</span>@endif
                        </a>
                    </div>
                </div>
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.analytics.*') || request()->routeIs('administrateur.analytics.*') ? 'active' : '' }}" href="{{ route('admin.analytics.dashboard') }}">
                ...
                <!-- PARAMÈTRES -->
                <div class="nav-section">
                    <div class="nav-section-title">⚙️ Configuration</div>
                    
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.settings.subscription*') ? 'active' : '' }}" href="{{ route('admin.settings.subscription') }}">
                            <i class="fas fa-crown"></i>
                            <span>💎 Abonnements Presta</span>
                        </a>
                    </div>
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.settings.commissions*') ? 'active' : '' }}" href="{{ route('admin.settings.commissions') }}">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.settings.*') && !request()->routeIs('admin.settings.features*') ? 'active' : '' }}" href="{{ route('admin.settings.general') }}">
                    ...
                    <div class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.system.*') ? 'active' : '' }}" href="{{ route('admin.system.status') }}">
        ...
        <div class="main-content">
            ...
            <header class="header">
                ...
                <div class="header-right">
                    <a href="{{ route('home') }}" class="btn btn-sm btn-outline-secondary me-2" title="Voir le site">
                    ...
                    <div class="user-menu dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            ...
                            <li><a class="dropdown-item" href="{{ route('admin.settings.general') }}"><i class="fas fa-cog me-2"></i>Paramètres</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.settings.commissions') }}"><i class="fas fa-percentage me-2"></i>Commissions</a></li>
    ...
    <script>
        // Sidebar toggle for mobile + scroll persistence
    ...
    <script>
        // EMERGENCY FIX: Unregister Service Worker to resolve navigation issues
