    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('prestataire.urgent-sales.show', $urgentSale) }}" class="text-red-600 hover:text-red-900 transition-colors duration-200">
            ...
            <form action="{{ route('prestataire.urgent-sales.update', $urgentSale) }}" method="POST" enctype="multipart/form-data" id="urgent-sale-form">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 mb-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title', $urgentSale->title) }}" required class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('title') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" required rows="6" placeholder="Décrivez votre article en détail..." class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('description') border-red-500 @enderror">{{ old('description', $urgentSale->description) }}</textarea>
                            <div class="mt-1">
                                @error('description')
                                    <p class="text-red-500 text-sm">{{ $message }}</p>
                                @enderror
                ...
                <!-- Catégorie -->
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 mb-6">
                    <h2 class="text-xl font-bold text-red-900 mb-4 border-b border-red-200 pb-2">Catégorie de la vente</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="parent_category_id" name="parent_category_id" required class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('parent_category_id') border-red-500 @enderror">
                        ...
                        <div id="subcategory-group" style="display: none;">
                            ...
                            <select id="category_id" name="category_id" class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('category_id') border-red-500 @enderror" disabled>
                ...
                <!-- Détails -->
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 mb-6">
                    <h2 class="text-xl font-bold text-red-900 mb-4 border-b border-red-200 pb-2">Détails de la vente</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="price" name="price" value="{{ old('price', $urgentSale->price) }}" required min="0" step="0.01" class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('price') border-red-500 @enderror">
                            @error('price')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mt-4">
                        <x-earnings-preview 
                            type="urgent_sale" 
                            inputId="price" 
                            :initialPrice="old('price', $urgentSale->price)" 
                            color="red" 
                        />
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <select id="condition" name="condition" required class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('condition') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $urgentSale->quantity) }}" required min="1" class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('quantity') border-red-500 @enderror">
                            @error('quantity')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @if($cashOnlyMode)
                                ...
                                <div class="bg-green-50 border border-green-200 rounded-lg p-4 text-sm text-green-800">
                                    ...
                                    <p class="mt-1">Cette vente reste en mode contact vendeur uniquement. Les acheteurs vous contacteront puis paieront directement avec vous.</p>
                                </div>
                            @else
                                <label for="payment_requirement" class="block text-sm font-medium text-red-700 mb-2">
                                    Paiement requis pour acheter
                                </label>
                                <select id="payment_requirement" name="payment_requirement" 
                                        class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('payment_requirement') border-red-500 @enderror">
                                    <option value="none" {{ old('payment_requirement', $urgentSale->payment_requirement) == 'none' ? 'selected' : '' }}>
                                        Aucun (contact vendeur seulement)
                                    </option>
                                    <option value="full" {{ old('payment_requirement', $urgentSale->payment_requirement) == 'full' ? 'selected' : '' }}>
                                        Paiement en ligne obligatoire
                                    </option>
                                </select>
                                <p class="text-xs text-gray-500 mt-1">
                                    <i class="fas fa-info-circle mr-1"></i>
                                    "Aucun" = l'acheteur vous contacte. "Paiement obligatoire" = paiement via la plateforme.
                                </p>
                        ...
                        <div>
                            ...
                            @if($urgentSale->inventory_item_id)
                                {{-- Déjà lié à l'inventaire --}}
                                <div class="p-4 bg-green-50 border border-green-200 rounded-lg">
                                    <div class="flex items-center gap-3 mb-3">
                                        <span class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white">
                                            <i class="fas fa-check"></i>
                                        </span>
                                        <div>
                                            <p class="font-medium text-green-800">Synchronisé avec l'inventaire</p>
                                            <p class="text-sm text-green-600">Article #{{ $urgentSale->inventory_item_id }}</p>
                                        </div>
                                    </div>
                                    <div class="flex gap-2">
                                        <a href="{{ route('prestataire.inventory.edit', $urgentSale->inventory_item_id) }}" 
                                           class="flex-1 px-4 py-2 bg-green-600 text-white text-sm text-center rounded-lg hover:bg-green-700 transition">
                                            <i class="fas fa-edit mr-1"></i> Voir / Modifier l'inventaire
                                        </a>
                                    </div>
                                    <p class="text-xs text-green-600 mt-2">
                                        <i class="fas fa-sync-alt mr-1"></i>
                                        Les modifications seront automatiquement synchronisées avec l'inventaire
                                    </p>
                                </div>
                            @else
                                {{-- Pas encore lié à l'inventaire --}}
                                <div class="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                                    <div class="flex items-center gap-3 mb-3">
                                        <span class="w-10 h-10 bg-amber-500 rounded-full flex items-center justify-center text-white">
                                            <i class="fas fa-box-open"></i>
                                        </span>
                                        <div>
                                            <p class="font-medium text-amber-800">Non synchronisé avec l'inventaire</p>
                                            <p class="text-sm text-amber-600">Cette annonce n'est pas encore liée à votre inventaire</p>
                                        </div>
                                    </div>
                                    
                                    <div class="flex items-center gap-3 mb-3">
                                        <input type="checkbox" id="sync_to_inventory" name="sync_to_inventory" value="1" 
                                               class="w-5 h-5 text-green-600 border-gray-300 rounded focus:ring-green-500">
                                        <label for="sync_to_inventory" class="text-sm font-medium text-gray-700">
                                            Créer un article dans l'inventaire à partir de cette annonce
                                        </label>
                                    </div>
                                    
                                    <p class="text-xs text-amber-600">
                                        <i class="fas fa-info-circle mr-1"></i>
                                        En cochant cette case, un article sera créé dans votre inventaire avec les mêmes informations. 
                                        Les futures modifications seront synchronisées automatiquement.
                                    </p>
                                </div>
                            @endif
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 mb-6">
                    ...
                    <div class="map-container">
                        ...
                        <div class="relative">
                            <input type="text" id="address" name="address" value="{{ old('address', $urgentSale->location) }}" required placeholder="Saisissez l'adresse ou cliquez sur la carte pour sélectionner une localisation" class="w-full px-3 py-2 border border-red-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('address') border-red-500 @enderror" autocomplete="off">
                            ...
                            <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $urgentSale->latitude ?? '') }}">
                            <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $urgentSale->longitude ?? '') }}">
                            @error('address')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <div class="flex flex-col sm:flex-row gap-3 mt-3">
                                <button type="button" id="getCurrentLocationBtn" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md transition duration-200 flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 mb-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4" id="existing-photos">
                            @foreach($urgentSale->photos as $index => $photo)
                                <div class="relative group" id="photo-container-{{ $index }}">
                                    <x-media-image :path="$photo" alt="Photo vente urgente" class="rounded-lg object-cover h-32 w-full border border-red-200" />
                    ...
                    <!-- Zone d'upload -->
                    <div class="border-2 border-dashed border-red-300 rounded-lg p-6 text-center bg-red-50 hover:border-red-400 transition-colors">
                ...
                <div class="flex justify-between items-center pt-8 border-t border-red-200">
                    <a href="{{ route('prestataire.urgent-sales.show', $urgentSale) }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300 px-6 py-3 rounded-lg transition duration-200 font-medium">
                        <i class="fas fa-arrow-left mr-2"></i>Annuler
                    </a>
                    
                    <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-lg transition duration-200 font-semibold shadow-lg hover:shadow-xl">
...
<div id="deletePhotoModal" class="fixed inset-0 z-50 hidden opacity-0 transition-opacity duration-200" style="backdrop-filter: blur(3px); background-color: rgba(0, 0, 0, 0.45);">
        ...
        <div class="bg-white rounded-t-2xl sm:rounded-2xl shadow-xl p-4 sm:p-6 w-full sm:max-w-md border border-red-200 transform transition-all duration-200 scale-95 opacity-0 modal-show">
            <div class="text-center">
                ...
                <div class="mt-5 flex flex-col sm:flex-row gap-3">
                    <button id="cancelDeletePhotoBtn" class="flex-1 px-4 py-2 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition duration-200 font-medium">
                        Annuler
                    </button>
                    <button id="confirmDeletePhotoBtn" class="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition duration-200 font-medium">
                        Supprimer
                    </button>
                </div>
            </div>
