        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-3 sm:p-4 lg:p-6 text-center">
                    ...
                    <p class="text-xs text-gray-600 mt-1 sm:mt-2 hidden sm:block">Titre, prix, quantité</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-3 sm:p-4 lg:p-6 text-center">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <i class="fas fa-map-marker-alt text-blue-600 text-lg sm:text-xl lg:text-2xl"></i>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-red-200 p-3 sm:p-4 lg:p-6 text-center">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <i class="fas fa-list-alt text-orange-600 text-lg sm:text-xl lg:text-2xl"></i>
                    </div>
                    ...
                    <p class="text-xs text-gray-600 mt-1 sm:mt-2 hidden sm:block">Catégorie, état, description</p>
                </div>
            </div>
            ...
            <div class="mt-6 bg-green-50 border border-green-200 rounded-xl p-4 sm:p-6">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-green-800 mb-2">Gestion boutique automatique</h4>
                        <ul class="text-sm text-green-700 space-y-1">
                            <li><i class="fas fa-check mr-2"></i>Le stock est suivi automatiquement</li>
                            <li><i class="fas fa-check mr-2"></i>Quand vous confirmez une vente, le stock diminue</li>
                            <li><i class="fas fa-check mr-2"></i>L'annonce passe en "Vendu" quand le stock atteint 0</li>
                        </ul>
                        <a href="{{ route('prestataire.inventory.index') }}" class="inline-flex items-center mt-3 text-green-600 hover:text-green-800 font-medium text-sm">
                            <i class="fas fa-boxes mr-2"></i>Gérer mon inventaire complet
