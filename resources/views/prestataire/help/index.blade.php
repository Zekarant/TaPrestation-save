...
<div class="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
    ...
    <x-how-it-works 
        title="🚀 Démarrage rapide en 4 étapes"
        subtitle="Suivez ces étapes pour commencer à recevoir des clients"
        layout="horizontal"
        :steps="[
            ['icon' => '1️⃣', 'title' => 'Complétez votre profil', 'desc' => 'Ajoutez votre photo, description et coordonnées pour inspirer confiance'],
            ['icon' => '2️⃣', 'title' => 'Créez vos services', 'desc' => 'Définissez vos prestations avec tarifs, durée et photos attractives'],
            ['icon' => '3️⃣', 'title' => 'Configurez vos disponibilités', 'desc' => 'Indiquez vos horaires de travail et zones d\'intervention'],
            ['icon' => '4️⃣', 'title' => 'Partagez votre profil', 'desc' => 'Utilisez votre QR Code et lien pour attirer des clients'],
        ]"
    />
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <x-action-card 
            ...
            description="Ajoutez une nouvelle prestation à votre catalogue"
        ...
        <x-action-card 
            icon="📅" 
            title="Gérer l'agenda" 
            description="Configurez vos disponibilités et horaires"
            url="{{ route('prestataire.agenda') }}"
        ...
        <x-action-card 
            ...
            description="Mettez votre matériel en location"
        ...
        <x-action-card 
            icon="📱" 
            title="Mon QR Code" 
            description="Partagez votre profil facilement"
            url="{{ route('prestataire.qrcode') }}"
            buttonText="Voir"
            color="orange"
        />
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <div class="px-4 py-3 sm:px-6 sm:py-4 bg-linear-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
        ...
        <!-- Service Management -->
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <div class="px-4 py-3 sm:px-6 sm:py-4 bg-linear-to-r from-green-50 to-emerald-50 border-b border-gray-200">
                <div class="flex items-center">
        ...
        <!-- Booking Management -->
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <div class="px-4 py-3 sm:px-6 sm:py-4 bg-linear-to-r from-purple-50 to-violet-50 border-b border-gray-200">
                <div class="flex items-center">
        ...
        <!-- Communication -->
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            <div class="px-4 py-3 sm:px-6 sm:py-4 bg-linear-to-r from-yellow-50 to-amber-50 border-b border-gray-200">
                <div class="flex items-center">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-200 overflow-hidden mb-6 sm:mb-8">
        <div class="px-4 py-3 sm:px-6 sm:py-4 bg-linear-to-r from-orange-50 to-red-50 border-b border-gray-200">
            <div class="flex items-center">
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="border-b border-gray-200 pb-4 sm:pb-6 last:border-b-0 last:pb-0">
                    ...
                    <div class="mt-2 sm:mt-3 text-gray-600 hidden" id="faq-answer-1">
                        <p class="text-xs sm:text-sm">Nous prélevons une commission de {{ get_setting('commission_services', '10') }}% sur chaque prestation réalisée via notre plateforme. Ce taux peut varier selon les catégories de services ({{ get_setting('commission_rentals', '8') }}% pour les locations, {{ get_setting('commission_food', '15') }}% pour la restauration). Les frais sont déduits automatiquement lors du paiement par le client.</p>
                    </div>
                </div>
    ...
    <!-- Contact support -->
    <div class="bg-linear-to-r from-blue-600 to-purple-600 rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
