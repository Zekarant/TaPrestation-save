...
@section('content')
    ...
    <div class="bg-blue-50">
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-4xl mx-auto">
                <div class="mb-8 text-center">
                    ...
                    <p class="text-lg text-blue-700">Réservation #{{ $booking->booking_number ?? 'N/A' }} -
                        {{ $booking->service->name ?? 'Service supprimé' }}</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-4 mb-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
                        <h2
                            class="text-xl font-bold text-blue-800 border-b border-blue-200 pb-2 sm:border-0 sm:pb-0 sm:mb-0">
                            Statut de la réservation</h2>
                    ...
                    @if(($booking->status ?? '') === 'pending' && $booking->service)
                        <div class="mt-4 flex flex-wrap gap-2">
                            ...
                            <button type="button" id="acceptBookingBtn"
                                class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1.5 px-3 rounded transition duration-200 text-sm">
                                <i class="fas fa-check mr-1"></i>Accepter
                            </button>
                            <!-- Reject button with modal -->
                            <button type="button" id="rejectBookingBtn"
                                class="bg-red-500 hover:bg-red-600 text-white font-bold py-1.5 px-3 rounded transition duration-200 text-sm">
                    ...
                    @elseif(($booking->status ?? '') === 'confirmed' && $booking->service)
                        <div class="mt-4 flex flex-wrap gap-2">
                            ...
                            <button type="button" id="completeBookingBtn"
                                class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1.5 px-3 rounded transition duration-200 text-sm">
                    ...
                    <div class="xl:col-span-2 space-y-8">
                        ...
                        <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-6">
                            <div class="flex items-center space-x-3 mb-6">
                                ...
                                <h2 class="text-xl font-bold text-blue-800 border-b-2 border-blue-200 pb-2">Informations du
                                    client</h2>
                            </div>
                            <div class="flex items-start space-x-6">
                                <div class="flex flex-col items-center">
                                    <div
                                        class="w-20 h-20 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden mb-2">
                                        @if($booking->client && $booking->client->user && $booking->client->user->profile_photo_url)
                                            <img src="{{ $booking->client->user->profile_photo_url }}"
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="bg-blue-50 rounded-lg p-3 flex items-center space-x-3">
                                                <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0h6m-6 0l-2 2m8-2l2 2m-2-2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6">
                                                    </path>
                                                </svg>
                                                <div>
                                                    <div class="text-xs font-medium text-blue-600 uppercase tracking-wide">
                        ...
                        <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-6">
                            <div class="flex items-center space-x-3 mb-6">
                                ...
                                <h2 class="text-xl font-bold text-blue-800 border-b-2 border-blue-200 pb-2">Détails du
                                    service</h2>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-4">
                                    <div class="bg-blue-50 rounded-lg p-3">
                                        <div class="text-xs font-medium text-blue-600 uppercase tracking-wide">Nom du
                                            service</div>
                                        <div class="text-lg font-bold text-blue-900 mt-1">
                                            {{ $booking->service->name ?? 'Service non disponible' }}</div>
                                    </div>
                                    <div class="bg-blue-50 rounded-lg p-3">
                                        <div class="text-xs font-medium text-blue-600 uppercase tracking-wide">Catégorie
                                        </div>
                                ...
                                <div class="space-y-4">
                                    <div class="bg-blue-50 rounded-lg p-3">
                                        ...
                                        <div class="text-2xl font-bold text-blue-600 mt-1">
                                            {{ number_format($booking->total_price ?? 0, 2, ',', ' ') }} €</div>
                                    </div>
                                    <div class="bg-blue-50 rounded-lg p-3">
                                        <div class="text-xs font-medium text-blue-600 uppercase tracking-wide">Durée</div>
                                        <div class="text-sm font-semibold text-blue-900 mt-1">
                                            {{ $booking->getDurationFormatted() }}</div>
                                    </div>
                                </div>
                            </div>
                            @if($booking->service && $booking->service->description)
                                <div class="mt-6 bg-blue-50 rounded-lg p-4">
                                    <div class="text-xs font-medium text-blue-600 uppercase tracking-wide mb-2">Description
                                    </div>
                        ...
                        <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-6">
                            <div class="flex items-center space-x-3 mb-6">
                                ...
                                <h2 class="text-xl font-bold text-blue-800 border-b-2 border-blue-200 pb-2">Détails de la
                                    réservation</h2>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-4">
                                    <div class="bg-blue-50 rounded-lg p-3">
                                        <div class="text-xs font-medium text-blue-600 uppercase tracking-wide">Date de début
                                        </div>
                                        <div class="text-lg font-bold text-blue-900 mt-1">
                                ...
                                <div class="space-y-4">
                                    <div class="bg-blue-50 rounded-lg p-3">
                                        <div class="text-xs font-medium text-blue-600 uppercase tracking-wide">Date de fin
                                        </div>
                                        <div class="text-lg font-bold text-blue-900 mt-1">
                            ...
                            @if($isMultiSlotSession)
                                <div class="mt-6 bg-blue-50 rounded-lg p-4">
                                    <div class="text-xs font-medium text-blue-600 uppercase tracking-wide mb-2">Session multiple
                                    </div>
                                    <div class="text-sm text-blue-700">
                                        Cette réservation fait partie d'une session de {{ $allBookings->count() }} créneaux.
                                        Prix total: <span class="font-bold">{{ number_format($totalSessionPrice, 2, ',', ' ') }}
                                            €</span>
                                    </div>
                                </div>
                            @endif
                            ...
                            @if(cleanNotesForDisplay($booking->client_notes))
                                <div class="mt-6 bg-blue-50 rounded-lg p-4">
                                    <div class="text-xs font-medium text-blue-600 uppercase tracking-wide mb-2">Notes du client
                                    </div>
                        ...
                        <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span
                                        class="font-medium">{{ $booking->created_at ? $booking->created_at->format('d/m/Y') : 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between text-sm">
                                ...
                                <div class="flex justify-between text-lg font-bold">
                                    <span>Total:</span>
                                    <span class="text-blue-600">{{ number_format($booking->total_price ?? 0, 2, ',', ' ') }}
                                        €</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                @if($booking->client && $booking->client->user)
                                    ...
                                    @if($booking->client->user->phone)
                                        <a href="tel:{{ $booking->client->user->phone }}"
        ...
        <div id="acceptConfirmationModal"
            ...
            <div
                class="bg-white rounded-xl shadow-2xl p-6 sm:p-8 max-w-md w-full mx-4 border-4 border-blue-500 transform transition-all duration-300">
                <div class="text-center">
                    ...
                    <div class="mt-6 flex flex-col sm:flex-row gap-3">
                        ...
                        <button id="confirmAcceptBtn"
                            class="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 font-medium">
                            Accepter
                        </button>
                    </div>
                </div>
