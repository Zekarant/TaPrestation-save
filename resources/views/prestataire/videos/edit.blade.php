                    ...
                    <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                        ...
                        <div>
                            ...
                            <div class="rounded-lg overflow-hidden border border-gray-200">
                                <video class="w-full h-auto bg-black max-h-64" controls playsinline webkit-playsinline x-webkit-airplay="allow" crossorigin="anonymous" preload="metadata">
                                    <source src="{{ $video->direct_url }}" type="{{ $video->getMimeType() }}">
