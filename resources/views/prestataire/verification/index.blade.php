    ...
    <div class="container mx-auto py-4 sm:py-6 md:py-8 px-2 sm:px-4">
        ...
        <div class="mb-6 md:mb-8">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                <div class="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-orange-500 to-orange-700 rounded-xl shadow-lg">
        ...
        @if(session('success'))
            <div class="mb-6 md:mb-8">
                <div class="bg-linear-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 p-4 rounded-r-lg shadow-sm">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-4 sm:p-8 hover:shadow-xl transition-all duration-300">
                ...
                @else
                    <div class="text-center py-6">
                        <div class="flex items-center justify-center w-20 h-20 mx-auto mb-4 bg-linear-to-br from-green-100 to-green-200 rounded-full shadow-lg">
                ...
                <div class="overflow-hidden rounded-xl border border-orange-100">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-orange-200">
                            <thead class="bg-linear-to-r from-orange-50 to-amber-50">
                                <tr>
                            ...
                            <tbody class="bg-white divide-y divide-orange-100">
                                @foreach($verificationRequests as $request)
                                    <tr class="hover:bg-linear-to-r hover:from-orange-50 hover:to-amber-50 transition-all duration-200">
                                        ...
                                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                                            @switch($request->document_type)
                                                @case('identity')
                                                    <span class="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-bold bg-linear-to-r from-orange-100 to-amber-100 text-orange-800 shadow-sm">
                                        ...
                                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                                            <a href="{{ route('prestataire.verification.show', $request) }}" 
                                               class="inline-flex items-center px-2 sm:px-3 py-2 border border-transparent text-xs sm:text-sm leading-4 font-bold rounded-lg text-white bg-linear-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 shadow-md hover:shadow-lg transition-all duration-300">
        ...
        @else
            <div class="bg-white rounded-xl shadow-lg border border-orange-100 p-4 sm:p-6 md:p-8 hover:shadow-xl transition-all duration-300">
                ...
                <div class="text-center py-8 sm:py-12">
                    <div class="flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 bg-linear-to-br from-orange-100 to-amber-100 rounded-full shadow-lg">
