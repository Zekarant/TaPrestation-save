        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{ route('prestataire.services.update', $service) }}" method="POST" enctype="multipart/form-data" id="service-form">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-6 mb-6">
                    ...
                    <!-- Aperçu des gains après commission (sur le prix total) -->
                    <div class="mt-4">
                        <x-earnings-preview 
                            type="service" 
                            inputId="price" 
                            quantityInputId="quantity"
                            :initialPrice="old('price', $service->price)" 
                            color="blue" 
                        />
                    </div>
                    ...
                    <div class="mt-6 border-t border-blue-200 pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label for="estimated_duration" class="block text-sm font-medium text-blue-700 mb-2">Durée</label>
                                <input type="number" id="estimated_duration" name="estimated_duration" 
                                       min="1" max="999" step="1"
                                       value="{{ old('estimated_duration', $service->estimated_duration ?? 1) }}" 
                                       class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('estimated_duration') border-red-500 @enderror"
                                       placeholder="Ex: 2">
                            ...
                            <div>
                                <label for="duration_unit" class="block text-sm font-medium text-blue-700 mb-2">Unité</label>
                                <select id="duration_unit" name="duration_unit" 
                                        class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('duration_unit') border-red-500 @enderror">
                                    <option value="minutes" {{ old('duration_unit', $service->duration_unit ?? 'hours') == 'minutes' ? 'selected' : '' }}>Minutes</option>
                                    <option value="hours" {{ old('duration_unit', $service->duration_unit ?? 'hours') == 'hours' ? 'selected' : '' }}>Heures</option>
                                    <option value="days" {{ old('duration_unit', $service->duration_unit) == 'days' ? 'selected' : '' }}>Jours</option>
                                </select>
                                @error('duration_unit')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <label for="buffer_time" class="block text-sm font-medium text-blue-700 mb-2">
                                    Temps tampon (min)
                                ...
                                <input type="number" id="buffer_time" name="buffer_time" 
                                       ...
                                       value="{{ old('buffer_time', $service->buffer_time ?? 15) }}" 
                                       class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('buffer_time') border-red-500 @enderror"
                                       placeholder="Ex: 15">
                                @error('buffer_time')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="mt-6 border-t border-blue-200 pt-4">
                        ...
                        @if($cashOnlyMode)
                            ...
                            <h3 class="text-sm sm:text-base font-semibold text-blue-800 mb-3">
                                <i class="fas fa-money-bill-wave text-green-600 mr-2"></i>Paiement client
                            </h3>
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4 text-sm text-green-800">
                                ...
                                <p class="mt-1">Ce service bascule automatiquement en paiement direct. Les clients réserveront puis régleront directement avec vous.</p>
                            </div>
                        @else
                        <h3 class="text-sm sm:text-base font-semibold text-blue-800 mb-3">
                            <i class="fas fa-hand-holding-usd text-green-600 mr-2"></i>Options de paiement
                        </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                ...
                                <input type="number" id="deposit_percentage" name="deposit_percentage" 
                                       ...
                                       value="{{ old('deposit_percentage', $service->deposit_percentage ?? 0) }}" 
                                       class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('deposit_percentage') border-red-500 @enderror"
                                       placeholder="Ex: 30">
                            ...
                            <div>
                                ...
                                <select id="payment_requirement" name="payment_requirement" 
                                        class="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('payment_requirement') border-red-500 @enderror">
                                    <option value="none" {{ old('payment_requirement', $service->payment_requirement ?? 'none') == 'none' ? 'selected' : '' }}>
                                        Aucun (réservation sans paiement immédiat)
                                    </option>
                                    <option value="deposit" {{ old('payment_requirement', $service->payment_requirement) == 'deposit' ? 'selected' : '' }}>
                                        Acompte obligatoire pour valider
                                    </option>
                                    <option value="full" {{ old('payment_requirement', $service->payment_requirement) == 'full' ? 'selected' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        max="720"
                                        step="1"
                                        value="{{ old('cancellation_hours', $service->cancellation_hours ?? 24) }}"
                                        class="w-full px-3 py-2 border border-amber-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 @error('cancellation_hours') border-red-500 @enderror"
                                        placeholder="Ex: 24"
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        max="100"
                                        step="1"
                                        value="{{ old('cancellation_refund_percentage', $service->cancellation_refund_percentage ?? 100) }}"
                                        class="w-full px-3 py-2 border border-amber-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 @error('cancellation_refund_percentage') border-red-500 @enderror"
                                        placeholder="Ex: 100"
                                    >
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4" id="existing-images">
                            @foreach($service->images as $image)
                                <div class="relative group" id="image-container-{{ $image->id }}">
                                    <x-media-image :path="$image->image_path" alt="Service Image" class="rounded-lg object-cover h-32 w-full border border-blue-200" />
