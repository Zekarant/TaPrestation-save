...
<div class="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100">
    <div class="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <x-help-box type="tip" title="💡 Conseils pour un service attractif" :dismissible="true" storageKey="service-create-tips">
                <ul class="space-y-1">
                    <li>• <strong>Titre clair</strong> – Décrivez précisément votre service (ex: "Coiffure à domicile femmes")</li>
                    <li>• <strong>Photos de qualité</strong> – Montrez vos réalisations, ça fait la différence !</li>
                    <li>• <strong>Tarif compétitif</strong> – Vérifiez les prix du marché dans votre zone</li>
                    <li>• <strong>Zone précise</strong> – Indiquez bien votre rayon d'intervention</li>
                </ul>
            </x-help-box>
