...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('notification-settings.update') }}" method="POST" class="space-y-6">
            @csrf
            @method('PATCH')
                    ...
                    <div class="p-5 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Nouvelles réservations, confirmations, annulations</p>
                            </div>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <div class="p-5 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Demandes de location et confirmations</p>
                            </div>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="p-5 flex items-center justify-between hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">Activer les notifications email</h3>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gray-600"></div>
                        </label>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <a href="{{ url()->previous() }}" class="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-semibold text-center transition-colors">
                    Annuler
                </a>
            </div>
        </form>
