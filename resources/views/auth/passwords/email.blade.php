...
<div class="min-h-screen flex items-center justify-center bg-gray-100 py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl w-full bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                @else
                    <form class="mt-6 sm:mt-8 space-y-4 sm:space-y-6" action="{{ route('password.email') }}" method="POST">
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('login') }}" class="font-medium text-blue-600 hover:text-blue-500 underline">
            ...
            <div class="hidden lg:flex items-center justify-center bg-linear-to-br from-blue-50 to-white p-8 md:p-12 lg:p-16">
                <!-- Logo container with enhanced styling -->
                <div class="bg-linear-to-br from-blue-50 to-white rounded-3xl p-6 sm:p-8 w-full max-w-md flex items-center justify-center aspect-square relative">
                    <!-- Halo effect behind the logo -->
                    <div class="absolute inset-0 rounded-3xl bg-linear-to-br from-blue-200/20 to-transparent blur-xl"></div>
                    
                    <div class="text-center relative z-10">
                        <div class="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 mx-auto flex items-center justify-center mb-4 sm:mb-6">
                            <!-- Circular background with gradient -->
                            <div class="absolute w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full bg-linear-to-br from-blue-100 to-blue-50 opacity-80"></div>
                            
                            <!-- Main logo with floating effect -->
                            <div class="relative w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-linear-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center shadow-xl transform transition-transform duration-300">
