<div
    ...
    <a href="{{ route('services.show', $service) }}" class="block">
        @if($service->coverImage)
            <img src="{{ Storage::url($service->coverImage->image_path) }}" alt="{{ $service->title }}"
        ...
        <div class="p-4">
            ...
            <p class="text-sm text-gray-600 mt-1 truncate">
                {{ $service->prestataire && $service->prestataire->user ? $service->prestataire->user->name : 'Prestataire inconnu' }}
            </p>
