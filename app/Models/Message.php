...
class Message extends Model
{
    ...
    /**
     * Types de messages autorisés (pas de vidéos ni fichiers)
     */
    ...
    public function getImageUrlAttribute(): ?string
    {
        ...
        // Fallback: utiliser serve-image.php
        return url('/serve-image.php?path=' . urlencode($this->image));
    }
    ...
    {
        $imagePath = $this->image_thumbnail ?: $this->image;
        ...
        // Fallback: utiliser serve-image.php
        return url('/serve-image.php?path=' . urlencode($imagePath));
    }
