...
<?php $__env->startSection('title', 'Tous les services - TaPrestation'); ?>
        ...
        <div class="tp-hero-inner">
            ...
            <?php if($services->count() > 0): ?>
                <div class="tp-hero-stats">
                    <div class="tp-hero-stat"><i class="fas fa-check-circle"></i> <?php echo e($services->total()); ?> service<?php echo e($services->total() > 1 ? 's' : ''); ?></div>
                    <?php if($categories->count() > 0): ?>
                        <div class="tp-hero-stat"><i class="fas fa-th-large"></i> <?php echo e($categories->whereNull('parent_id')->count()); ?> catégorie<?php echo e($categories->whereNull('parent_id')->count() > 1 ? 's' : ''); ?></div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 mt-4 sm:mt-6">
        <?php if($services->count() > 0): ?>
            <div class="tp-results-count">
                <strong><?php echo e($services->total()); ?></strong> résultat<?php echo e($services->total() > 1 ? 's' : ''); ?><?php if(request('q')): ?> pour « <?php echo e(request('q')); ?> »<?php endif; ?>
            </div>
            ...
            <div class="tp-grid">
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="tp-card" data-card-link role="link" tabindex="0" data-href="<?php echo e(route('services.show', $service)); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-image','data' => ['path' => $firstPhoto,'alt' => $service->title,'style' => 'width:100%;height:100%;object-fit:cover;display:block']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['path' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($firstPhoto),'alt' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($service->title),'style' => 'width:100%;height:100%;object-fit:cover;display:block']); ?>
...
<?php endif; ?>
                            ...
                            <?php endif; ?>
                            <div class="tp-card-time"><?php echo e($service->created_at->diffForHumans(null, true, true)); ?></div>
                        </div>
 
                        <div class="tp-card-body">
                            <?php if($service->price): ?>
                                <div class="tp-card-price"><?php echo e(number_format($service->price, 0, ',', ' ')); ?> €</div>
                            <?php else: ?>
                                <div><span class="tp-card-price-devis">Sur devis</span></div>
                            <?php endif; ?>
                            <div class="tp-card-title"><?php echo e($service->title); ?></div>
                            <div class="tp-card-provider"><?php echo e($prestataireName); ?></div>
                            <div class="tp-card-meta">
                                ...
                                <?php if(isset($service->distance_km) && $service->distance_km !== null): ?><span><i class="fas fa-route"></i> <?php echo e($service->distance_km); ?> km</span><?php endif; ?>
                            </div>
                            ...
                            <div class="tp-card-footer">
                                <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <?php if(!$isOwner): ?>
                                        <a href="<?php echo e($canContact ? route('client.messaging.start', $prestataire) : route('services.show', $service)); ?>" class="tp-card-btn" onclick="event.stopPropagation()">Contacter</a>
                                        <a href="<?php echo e(($showBooking && \Illuminate\Support\Facades\Route::has('bookings.create')) ? route('bookings.create', $service) : route('services.show', $service)); ?>" class="tp-card-btn tp-card-btn-primary" onclick="event.stopPropagation()"><?php echo e(($service->reservable ?? true) ? 'Réserver' : 'Demander'); ?></a>
                                    <?php endif; ?>
                                <?php else: ?>
            ...
            <?php if($services->hasPages()): ?>
                <div class="tp-pagination"><?php echo e($services->appends(request()->query())->links()); ?></div>
            <?php endif; ?>
        <?php else: ?>
            <div class="tp-empty">
                ...
                <a href="<?php echo e(route('services.index')); ?>" class="tp-empty-btn"><i class="fas fa-redo" style="font-size:10px"></i> Réinitialiser</a>
            </div>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wamp64\www\TaPrestation-master - Copie\resources\views/services/index-modern.blade.php ENDPATH**/ ?>