...
<?php if (! $__env->hasRenderedOnce('a8504cd9-4202-4491-9acf-5131900bbcdf')): $__env->markAsRenderedOnce('a8504cd9-4202-4491-9acf-5131900bbcdf'); ?>
    <style>
...
<nav id="mobile-bottom-nav" class="sm:hidden fixed bottom-0 left-0 right-0 z-[90]">
    <div class="flex justify-around items-center h-[60px] px-1">
        ...
        <a href="<?php echo e($homeRoute); ?>"
            class="mobile-nav-link flex flex-col items-center justify-center flex-1 h-full py-2 <?php echo e(request()->routeIs('home') ? 'is-active-blue' : ''); ?>">
            <svg fill="<?php echo e(request()->routeIs('home') ? 'currentColor' : 'none'); ?>" stroke="currentColor"
                viewBox="0 0 24 24">
        ...
        <?php if($videosFeedRoute): ?>
            <a href="<?php echo e($videosFeedRoute); ?>"
                class="mobile-nav-link flex flex-col items-center justify-center flex-1 h-full py-2 <?php echo e(request()->routeIs('videos.feed') ? 'is-active-purple' : ''); ?>">
                <svg fill="<?php echo e(request()->routeIs('videos.feed') ? 'currentColor' : 'none'); ?>" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <?php if($foodExploreRoute): ?>
            <a href="<?php echo e($foodExploreRoute); ?>"
                class="mobile-nav-link flex flex-col items-center justify-center flex-1 h-full py-2 <?php echo e(request()->routeIs('food.*') ? 'is-active-orange' : ''); ?>">
        ...
        <!-- Prestataire Agenda -->
        <?php if($user && $user->hasRole('prestataire') && $prestataireAgendaRoute): ?>
            <a href="<?php echo e($prestataireAgendaRoute); ?>"
                class="mobile-nav-link flex flex-col items-center justify-center flex-1 h-full py-2 <?php echo e(request()->routeIs('prestataire.agenda*') ? 'is-active-orange' : ''); ?>">
                <svg fill="<?php echo e(request()->routeIs('prestataire.agenda*') ? 'currentColor' : 'none'); ?>" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <?php if($user && $user->hasRole('prestataire') && $prestataireVideosCreate): ?>
            <a href="<?php echo e($prestataireVideosCreate); ?>"
                class="mobile-nav-link flex flex-col items-center justify-center flex-1 h-full py-2 <?php echo e(request()->routeIs('prestataire.videos*') ? 'is-active-red' : ''); ?>">
                <div class="relative">
                    <svg fill="<?php echo e(request()->routeIs('prestataire.videos*') ? 'currentColor' : 'none'); ?>"
...
</script><?php /**PATH D:\wamp64\www\TaPrestation-master - Copie\resources\views/components/mobile-bottom-nav.blade.php ENDPATH**/ ?>