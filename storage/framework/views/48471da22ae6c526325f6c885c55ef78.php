<?php $__env->startSection('preload_hero'); ?>
<link rel="preload" href="<?php echo e(asset('images/og-image.png')); ?>" as="image" type="image/png" fetchpriority="high">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('title', 'TaPrestation - Trouvez, réservez, achetez, louez'); ?>
<?php $__env->startSection('meta_description', 'TaPrestation réunit services, location, vente et food sur une interface moderne avec téléchargement d’application mis en avant.'); ?>
<?php $__env->startSection('meta_keywords', 'prestataire, réservation, location, vente, food, TaPrestation, PWA'); ?>
<?php $__env->startSection('canonical', config('app.url', 'https://taprestation.com')); ?>
<?php $__env->startSection('og_title', 'TaPrestation - L’application locale tout-en-un'); ?>
<?php $__env->startSection('og_description', 'Trouvez un prestataire, réservez un service, louez ou achetez localement depuis une seule interface.'); ?>
<?php $__env->startSection('og_type', 'website'); ?>
<?php $__env->startSection('twitter_title', 'TaPrestation - Réservation, services et vente'); ?>
<?php $__env->startSection('twitter_description', 'Une home plus moderne avec installation d’application mise en avant.'); ?>
...
<div class="tp-home-v2">
            ...
            <div class="tp-hero-v2__content">
                ...
                <div class="tp-mini-stats" aria-label="Statistiques plateforme">
                    <div class="tp-mini-stat">
                        <strong><?php echo e(number_format($stats['total_prestataires'] ?? 0, 0, ',', ' ')); ?></strong>
                        <span>prestataires</span>
                    </div>
                    <div class="tp-mini-stat">
                        <strong><?php echo e(number_format($stats['total_services'] ?? 0, 0, ',', ' ')); ?></strong>
                        <span>services</span>
                    </div>
                    <div class="tp-mini-stat">
                        <strong><?php echo e(number_format((float) ($stats['avg_rating'] ?? 4.9), 1, ',', ' ')); ?>/5</strong>
                        <span>note</span>
                    </div>
                </div>
            </div>
    ...
    <section class="tp-section-v2">
        <div class="tp-shell">
            ...
            <div class="tp-category-grid-v2">
                <?php $__currentLoopData = $displayCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $visual = $categoryVisuals[$categoryName] ?? ['icon' => 'fa-sparkles']; ?>
                    <a href="<?php echo e(url('/services?search=' . urlencode($categoryName))); ?>" class="tp-category-card-v2">
                        <span class="tp-category-card-v2__icon">
                            <i class="fas <?php echo e($visual['icon']); ?>" aria-hidden="true"></i>
                        </span>
            ...
            <div class="tp-trust-grid-v2">
                <?php $__currentLoopData = $trustPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="tp-trust-card-v2">
                        <div class="tp-trust-card-v2__icon"><i class="fas <?php echo e($point['icon']); ?>" aria-hidden="true"></i></div>
            ...
            <div class="tp-panels-v2">
                <article class="tp-panel-v2">
                    ...
                    <div class="tp-list-v2">
                        <?php $__currentLoopData = $clientBenefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div><i class="fas fa-check"></i><span><?php echo e($item); ?></span></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </article>
                ...
                <article class="tp-panel-v2 tp-panel-v2--accent">
                    ...
                    <div class="tp-list-v2">
                        <?php $__currentLoopData = $proBenefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div><i class="fas fa-check"></i><span><?php echo e($item); ?></span></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </article>
    ...
    <?php if(isset($featuredPrestataires) && $featuredPrestataires->count()): ?>
    <section class="tp-section-v2 tp-section-v2--soft">
        <div class="tp-shell">
            ...
            <div class="tp-provider-grid-v2">
                <?php $__currentLoopData = $featuredPrestataires->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestataire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="tp-provider-card-v2">
                        <div class="tp-provider-card-v2__head">
                            <div class="tp-provider-card-v2__avatar">
                                <?php if(!empty($prestataire->profile_photo_url ?? null)): ?>
                                    <img src="<?php echo e($prestataire->profile_photo_url); ?>" alt="<?php echo e($prestataire->user?->name ?? 'Prestataire'); ?>">
                                <?php elseif(!empty($prestataire->photo ?? null)): ?>
                                    <img src="<?php echo e(asset('storage/' . $prestataire->photo)); ?>" alt="<?php echo e($prestataire->user?->name ?? 'Prestataire'); ?>">
                                <?php else: ?>
                                    <span><?php echo e(strtoupper(substr($prestataire->user?->name ?? 'P', 0, 1))); ?></span>
                                <?php endif; ?>
                            </div>
                            <div>
                                <h3><?php echo e($prestataire->user?->name ?? 'Prestataire'); ?></h3>
                                <p><?php echo e($prestataire->city ?? 'France'); ?> <?php if(!empty($prestataire->profession ?? null)): ?> · <?php echo e($prestataire->profession); ?> <?php endif; ?></p>
                            </div>
                        </div>

                        <div class="tp-provider-card-v2__stats">
                            <span><?php echo e($prestataire->services->count() ?? 0); ?> service<?php echo e(($prestataire->services->count() ?? 0) > 1 ? 's' : ''); ?></span>
                            <span><?php echo e(number_format((float) ($prestataire->average_rating ?? 0), 1, ',', ' ')); ?>/5</span>
                        </div>

                        <a href="<?php echo e(route('prestataires.show', $prestataire)); ?>" class="tp-provider-card-v2__link">Voir le profil</a>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="tp-shell">
            <div class="tp-final-v2">
                ...
                <div class="tp-final-v2__actions">
                    <a href="<?php echo e(route('services.index')); ?>" class="tp-btn-v2 tp-btn-v2--dark">Explorer</a>
                    <a href="<?php echo e(route('prestataire.register')); ?>" class="tp-btn-v2 tp-btn-v2--ghost-dark">Créer mon espace</a>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wamp64\www\TaPrestation-master - Copie\resources\views/home.blade.php ENDPATH**/ ?>